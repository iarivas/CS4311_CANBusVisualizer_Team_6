...
dbc = cantools.database.load_file(
    '../CSS-Electronics-SAE-J1939-2018-08_v1.2.dbc')
router = APIRouter()
...
class packetManager():
    ...
    def sendPackets(arbitrationID, data):
        ...
        msg = can.Message(arbitration_id=arbitrationID,
                          data=msg.encode(data), is_extended_id=False)
        bus.send(msg)
    ...
    def editPacket(self, packet, attribute, setTo):
        return
